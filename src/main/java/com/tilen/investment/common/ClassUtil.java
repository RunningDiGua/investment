...
public class ClassUtil {
  ...
  public static Object getValue(Object targetObj, String methodKeyword, String fieldName) {
    String getMethodName =
        methodKeyword + fieldName.substring(0, 1).toUpperCase() + fieldName.substring(1);
